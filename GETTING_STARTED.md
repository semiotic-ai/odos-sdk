...
[dependencies]
odos-sdk = "0.27"
alloy = { version = "1.1", features = ["full"] }  # For wallet/signer functionality
...
odos-sdk = { version = "0.27", default-features = false, features = ["minimal"] }

# All contracts: V2 + V3 + Limit Orders
odos-sdk = { version = "0.27", default-features = false, features = ["contracts"] }

# Specific router versions
odos-sdk = { version = "0.27", default-features = false, features = ["v2"] }
odos-sdk = { version = "0.27", default-features = false, features = ["v3"] }
```
...
```toml
# For V2 router
odos-sdk = { version = "0.27", features = ["v2"] }

# For V3 router
odos-sdk = { version = "0.27", features = ["v3"] }

# For all features
odos-sdk = { version = "0.27", features = ["contracts"] }
```
